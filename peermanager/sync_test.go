...
func TestFastSyncDisabling(t *testing.T) {
	...
	go pmFull.handle(pmFull.newPeer(63, p2p.NewPeer(nodetable.NodeID{}, "empty", nil), io2))
	go pmEmpty.handle(pmEmpty.newPeer(63, p2p.NewPeer(nodetable.NodeID{}, "full", nil), io1))
